    ...
    <div class="container">
      ...
      <form class="center-from" method="post" action="estudante_controller.php">
        ...
        <div class="form-group col-sm-4">
          ...
          <input name="cpf" type="text" required ng-model="cpf" class="form-control" id="cpf" placeholder="000.000.000-00">
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
          ...
          <input name="rg" type="text" required ng-model="rg" class="form-control" id="rg" placeholder="0.000.000">
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
          <label for="sexo">Sexo</label>
            <select name="sexo" onchange="changeType()" required ng-model="sexo" class="form-control">
              <option></option>
        ...
        <div class="form-group col-sm-4">
          ...
          <select name="tipoUsuario" id="tipoUsuario" onchange="changeType()" required ng-model="tipoUsuario" class="form-control">
            <option></option>
