  ...
  <body ng-controller="pessoasController">
    ...
    <div class="container">
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#cadastrarFuncionario" aria-controls="cadastrarFuncionario" role="tab" data-toggle="tab">Cadastrar Funcionarios</a></li>
        <li role="presentation"><a href="#consultarFuncionario" aria-controls="consultarFuncionario" role="tab" data-toggle="tab">Consultar Funcionarios</a></li>
      </ul>
      <!-- DADOS FuncionarioIS -->
      <form class="center-from" method="post" action="funcionario_controller.php">
        ...
        <div class="form-group col-sm-4">
          ...
          <input name="cep" type="text" required ng-model="cep" class="form-control" id="cep" placeholder="00000-000">
        </div>
        <div class="form-group col-sm-4">
          <label for="endereco">Endereço</label>
          <input name="endereco" type="text" required ng-model="endereco" class="form-control" id="endereco" placeholder="Endereço">
        </div>
        <div class="form-group col-sm-4">
          <label for="numero">Número</label>
          <input name="numero" type="numeric" required ng-model="numero" class="form-control" id="numero" placeholder="00">
        </div>
        <div class="form-group col-sm-4">
          <label for="bairro">Bairro</label>
          <input name="bairro" type="text" required ng-model="bairro" class="form-control" id="bairro" placeholder="Bairro">
        </div>
        <div class="form-group col-sm-4">
          <label for="cidade">Cidade</label>
          <input name="cidade" type="text" required ng-model="cidade" class="form-control" id="cidade" placeholder="Cidade">
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
          ...
          <input name="dddCelular1" type="numeric" required ng-model="dddCelular1" class="form-control" id="dddCelular1" placeholder="(00)">
        </div>
        <div class="form-group col-sm-4">
          <label for="telefoneCelular1">Celular 1</label>
          <input name="telefoneCelular1" type="numeric" required ng-model="telefoneCelular1" class="form-control" id="telefoneCelular1" placeholder="00000-0000">
        </div>
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-4">
          ...
          <input name="departamento" type="text" required ng-model="departamento" class="form-control" id="departamento" placeholder="Área de trabalho">
        </div>
        <div class="form-group col-sm-4">
          <label for="profissao">Profissão</label>
          <input name="profissao" type="text" required ng-model="profissao" class="form-control" id="profissao" placeholder="Profissao">
        </div>
        <div class="form-group col-sm-4">
          <label for="dataCadastro">Data de cadastro</label>
          <input name="dataCadastro" type="date" required ng-model="dataCadastro" class="form-control" id="dataCadastro" placeholder="dataCadastro">
        </div>
        <br><br><br><br>
        <div class="borda"></div>
        <br>
